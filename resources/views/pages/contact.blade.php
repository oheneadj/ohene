<x-layouts.app title="Contact Ohene Adjei Effah — Full-Stack Web Developer"
    ...
    <section class="bg-black text-white relative overflow-hidden py-24 md:py-32 border-b border-white/10">
        ...
        <div class="max-w-6xl mx-auto px-7 relative z-10">
            ...
            <div class="flex flex-wrap gap-4 mt-6">
                <a href="mailto:oheneadjei.dev@gmail.com?subject=Project%20inquiry"
                    class="flex items-center gap-2.5 bg-white/5 border border-white/10 backdrop-blur-md rounded-full px-5 py-3 text-sm font-medium hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5 transition-premium text-slate-200 hover:text-white group">
                ...
                <a href="https://linkedin.com/in/oheneadj" target="_blank" rel="noopener"
                    class="flex items-center gap-2.5 bg-white/5 border border-white/10 backdrop-blur-md rounded-full px-5 py-3 text-sm font-medium hover:bg-white/10 hover:border-white/20 hover:-translate-y-0.5 transition-premium text-slate-200 hover:text-white group">
                    <svg class="w-4 h-4 text-slate-400 group-hover:text-white transition-colors" fill="currentColor"
                        viewBox="0 0 24 24">
        ...
        <section class="max-w-6xl mx-auto px-7 pb-20 ">
            <div class="max-w-5xl">
                <div class="flex items-end justify-between gap-4 mb-8">
                    <div>
                        ...
                        <h2 class="font-display text-2xl font-semibold">What people say</h2>
                    </div>
                    <div class="flex gap-2">
                        <button id="prev-testimonial"
                            class="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center hover:bg-slate-50 transition-colors text-black"
                ...
                <div id="testimonial-carousel"
                    class="flex gap-6 overflow-x-auto snap-x snap-mandatory scroll-smooth pb-4 [&::-webkit-scrollbar]:hidden"
                    style="scrollbar-width: none; -ms-overflow-style: none;">
                    @foreach ($testimonials as $testimonial)
                        <div class="w-full md:w-[calc(50%_-_12px)] shrink-0 snap-start">
            ...
            <script>
                document.addEventListener('DOMContentLoaded', () => {
                    ...
                    // Scroll by the full container width to advance a full "page" (2 items on desktop)
                ...
                <div class="border-t border-black/10">
                    @foreach ($faqs as $faq)
                        <details class="group [&_summary::-webkit-details-marker]:hidden border-b border-black/10">
                            <summary
                                class="flex items-center justify-between gap-4 cursor-pointer py-6 font-display font-medium text-xl hover:text-slate-600 transition-colors">
                                <span>{{ $faq->question }}</span>
                                <span
                                    class="flex-shrink-0 transition-transform duration-300 group-open:rotate-180 text-slate-400 group-hover:text-black">

<x-layouts.app title="Blog — Ohene Adjei Effah"
    ...
    <section class="bg-black text-white relative overflow-hidden min-h-[40vh] flex flex-col justify-center py-20 border-b border-white/10">
        ...
        <div class="max-w-6xl mx-auto px-7 relative z-10 w-full">
            ...
            <p class="text-slate-300 max-w-xl text-lg">Practical write-ups on Laravel, WordPress performance, and
                shipping secure, scalable web applications — pulled from real client work.</p>
        </div>
    </section>

        ...
        <div class="max-w-6xl mx-auto px-7 relative z-10 w-full">
            ...
            <div class="flex flex-wrap items-center justify-between gap-6">
                <div class="flex flex-wrap items-center gap-3 text-slate-400 text-sm font-mono">
                    <span class="text-white font-semibold">{{ now()->year - config('site.stats.career_start_year') }} Years Exp</span>
                ...
                <div class="flex flex-wrap items-center gap-3">
                    <x-social-pill :href="config('site.social.twitter')">
                        <x-slot:icon>
                    ...
                    <x-social-pill :href="config('site.social.youtube')">
                        <x-slot:icon>
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">

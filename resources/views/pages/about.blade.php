            ...
            <div class="flex flex-wrap items-center justify-between gap-6">
                ...
                <div class="flex flex-wrap items-center gap-3">
                    ...
                    <a href="{{ asset('Ohene_Adjei_Effah_Resume.pdf') }}" download data-track="resume_download"
                        class="inline-flex items-center gap-2 border border-white/20 text-slate-300 font-mono text-sm font-medium rounded-full px-5 py-2 hover:bg-white/10 hover:text-white hover:border-white/30 transition-premium text-emerald-400 hover:text-emerald-300">

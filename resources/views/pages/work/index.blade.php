<x-layouts.app title="Work & Case Studies — Ohene Adjei Effah"
    ...
    <section class="bg-black text-white relative overflow-hidden min-h-[40vh] flex flex-col justify-center py-20 border-b border-white/10">
        ...
        <div class="max-w-6xl mx-auto px-7 relative z-10 w-full">
            ...
            <p class="text-slate-300 max-w-xl text-lg mb-8">A few projects that show how I approach a problem, from
                first requirement to what it delivered.</p>

            <div class="flex flex-wrap items-center gap-4">
                <div
                    class="inline-flex items-center gap-2 bg-white/10 text-white font-mono text-sm font-semibold tracking-wide rounded-full px-5 py-2">
                    {{ $projects->total() }} Case Studies
                </div>
        ...
        @else
            ...
            <div id="load-more-container" class="mt-12 flex justify-center">
                @if ($projects->hasMorePages())
                    <button data-url="{{ $projects->nextPageUrl() }}" onclick="loadMoreProjects(this)"
                        ...
                        <svg class="w-4 h-4 group-hover:translate-y-0.5 transition-transform" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
